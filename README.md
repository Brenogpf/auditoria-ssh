...
```bash
git clone https://github.com/seu-usuario/auditoria-ssh.git
...
```
*Observe como o script explora cada uma das vulnerabilidades com sucesso.*
...
```
*O script irá aplicar todas as 7 correções de segurança automaticamente.*
